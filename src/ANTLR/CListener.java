...
public interface CListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link CParser#functionCallDeclarator}.
	 * @param ctx the parse tree
	 */
	void enterFunctionCallDeclarator(@NotNull CParser.FunctionCallDeclaratorContext ctx);
	/**
	 * Exit a parse tree produced by {@link CParser#functionCallDeclarator}.
	 * @param ctx the parse tree
	 */
	void exitFunctionCallDeclarator(@NotNull CParser.FunctionCallDeclaratorContext ctx);
